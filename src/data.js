...
const _RAW_BUYERS = [
  {
    ...
    headcount: "20,000",
    offices: "570+",
    ownership: "National consolidator",
    sponsor: "—",
    ...
    flags: [],
    fit: { size: 5, benefits: 3, pe: 0, precedent: 5 },
  ...
  },
  {
    ...
    notes: "Captive distributor through retail brokers. Direct product overlap — but capital base smaller than top tier.",
    flags: [],
    fit: { size: 2, benefits: 5, pe: 0, precedent: 3 },
