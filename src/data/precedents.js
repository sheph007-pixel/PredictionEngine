...
export const PUBLIC_COMP_BANDS = {
  ...
  notes: 'Forward EBITDA multiples for listed brokers. CONFIRMATORY context only — the size-bucket bands in the main system prompt are anchored on private-M&A guaranteed-multiple data (Reagan-style, \'23-\'25 vintage) and already reflect the public-to-private gap. Do NOT additionally discount the private size-bucket bands using these public comps; that double-counts.',
};
