...
// Process tasks tracked with Reagan. Each can be marked done / in-progress / upcoming.
// Projected dates cascade from the current task's date.
const PROCESS_TASKS = [
...
const PHASES = ["Preparation", "Marketing Phase 1", "Marketing Phase 2", "Exclusivity", "Close"];

// Anchor: where we are right now in the process. User-editable.
const PROCESS_DEFAULT = {
  currentTaskId: "cim_final",     // we're finalizing CIM as of late April 2026
  currentTaskDate: "2026-04-30",
};

// Market multiples for benefits brokers, mid-2026 (mid-cycle, post-rate-cut)
// Strategic captive specialists trade at premiums; PE platforms aggressive but disciplined;
// public consolidators benchmarked to BWIN/AON; regionals at discount.
// Per-buyer multiple ranges encoded below as [low, mid, high].
...
window.KENNION = { STAGES, STAGE_INDEX, PROCESS_TASKS, PHASES, PROCESS_DEFAULT, BUYERS };
